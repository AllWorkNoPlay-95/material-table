...
export default class MTableCell extends React.Component {
    getRenderValue() {
        ...
        if (this.props.columnDef.render) {
            ...
            if (this.props.value instanceof Date) {
                ...
                return parseISO(this.props.value).toLocaleDateString(
                    dateLocale);
            } else {
            ...
            if (this.props.value instanceof Date) {
                ...
                return parseISO(this.props.value).toLocaleTimeString(
                    dateLocale);
            } else {
                return this.props.value;
            }
    ...
    getCurrencyValue(currencySetting, value) {
        if (currencySetting !== undefined) {
            return new Intl.NumberFormat(
                currencySetting.locale !== undefined ? currencySetting.locale
                    : "en-US",
                {
                    style: "currency",
                    currency:
    ...
    getStyle = () => {
        ...
        if (typeof this.props.columnDef.cellStyle === "function") {
            cellStyle = {
                ...cellStyle,
                ...this.props.columnDef.cellStyle(this.props.value,
                    this.props.rowData),
            };
        } else {
        ...
        if (cellEditable) {
            renderValue = (
                <div
                    ...
                    onClick={(e) => {
                        e.stopPropagation();
                        onCellEditStarted(this.props.rowData,
